...
// Import the image (adjust path based on your Projects.jsx location, e.g., src/components/Projects.jsx → ../images/)
import myWayImage from "../images/newIMG2.jpg";  // Assuming same image for both; import others as needed

const projects = [
  {
    img: myWayImage,  // Use imported variable
    title: "MyWay",
...
function Projects() {
  return (
    <section className="min-h-screen bg-gray-900 py-16 px-6">
      ...
      {/* Project Cards - Reduced gap for tighter spacing */}
